import { k as createComponent, l as renderTemplate, q as renderHead, m as renderComponent } from './astro/server_q1UfLich.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Image } from './_astro_assets_Dd7jWlqW.mjs';
...
const imagenDoctor = new Proxy({"src":"/_astro/doctor.DacvNxJW.jpg","width":1920,"height":1920,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/macbookpro/Desktop/sancor/public/doctor.jpg";
							}
...
}, "/Users/macbookpro/Desktop/sancor/src/components/NotFound.astro", void 0);
